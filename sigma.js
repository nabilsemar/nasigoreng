...
openplaylist.addEventListener('click', function() {
    window.location.href = 'https://music.youtube.com/playlist?list=PL0Ds4RpitLVXLaIJeK5JbxECqoCCPRscL';
    // List();
});

const MyArtO = document.getElementById('MyArt');
MyArtO.addEventListener('click', function() {
    // window.location.href = 'https://music.youtube.com/playlist?list=PL0Ds4RpitLVXLaIJeK5JbxECqoCCPRscL';
    MyArt();
});
